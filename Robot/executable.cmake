# This file is copied from k210 SDK
# Comment line is the original code from k210 SDK and the first line below the comment line is the modified code.
...
if (NOT BUILDING_SDK)
    if(EXISTS ${SDK_ROOT}/libkendryte.a)
        ...
        add_subdirectory(${SDK_ROOT}/lib ${CMAKE_CURRENT_BINARY_DIR}/lib)
    endif()
endif ()
